                    ...
                    <div class="material-in-store" v-for="material in materials" :key="material.id">
                        <div class="material-preview">
                            <img v-if="material.type === 1 ||material.type === 3 || material.thumbUrl"
                                 :src="material.previewUrl || material.thumbUrl">
                            <span v-else>{{material.materialContent + UNSUBSCRIBE_SMS_POSTFIX}}</span>
                        </div>
        ...
        methods: {
            ...
            fetchMaterials(reset) {
                ...
                JourneyMaterialApiV1
                    .getMaterials('', this.name, this.pageNumber, 0) // 素材类型 0 for sms, 1 for email, 5 for all email
            ...
            async preview(material) {
                ...
                if (material.type === 1 || material.type === 3) {
                    ...
                    // 短信，拼接签名
                    this.previewMaterial.materialContent = this.previewMaterial.materialContent;
            ...
            choose(material) {
                ...
                if ((material.type === 1 || material.type === 3) && material.materialContent.trim() === '') {
                    ...
                    // 短信，拼接签名
                    // this.previewMaterial.materialContent = this.signature + this.previewMaterial.materialContent;
                    this.previewMaterial.materialContent = material.materialContent;
