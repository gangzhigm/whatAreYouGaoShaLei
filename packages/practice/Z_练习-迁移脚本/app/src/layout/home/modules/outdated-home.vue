                    ...
                    <div class="order-rank">
                        ...
                        <table class="order-table">
                            ...
                            <tbody>
                                <tr v-for="order in orderRankData">
                                    <td :class="order.journeyId ? 'theme-text' : 'light-content-text'">{{order.name}}
                                    </td>
                        ...
                        <div class="open-journey">
                            <button class="journey-btn btn btn-lg btn-round btn-theme" type="button"
                                :disabled="$has('homepage_journey')" @click="createJourney">
...
import { fansDiagram, marketDiagram, offlineOrderDiagram } from '../index-diagram-data';
        ...
        .order-rank {
            ...
            .open-journey {
                ...
                .journey-btn {
                    ...
                    width: 60%;
                    margin: 16px auto;
                    @include box-shadow(0 0 3px rgba($theme, 0.8));
                    @include linear-gradient(to right, $theme, #17f9a8);
                    @include linear-gradient(to right, $theme, #17f9a8);
                    @include transition();

                    &:hover {
                        @include box-shadow(0 0 3px rgba($theme, 0.2));
                    }
                }
