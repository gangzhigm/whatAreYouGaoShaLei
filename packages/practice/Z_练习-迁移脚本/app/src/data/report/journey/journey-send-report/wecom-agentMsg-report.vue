<template>
    <div class="wecom-agent-broadcast">
                ...
                <div class="charts">
                    <div class="chart half right-margin">
                        <div class="chart-head">
                            ...
                            <span class="disabled-text">
                                {{'controller.statisticsTime' | t}}: {{'frequency.every' | t}} 5{{'controller.minutes' | t}}
                            </span>
                        </div>
                    ...
                    <div class="chart half">
                        <div class="chart-head">
                            ...
                            <span class="disabled-text">
                                {{'controller.statisticsTime' | t}}:{{'frequency.every' | t}} 一{{'controller.hours' | t}}
                            </span>
                        </div>
        ...
        <!--下载弹窗-->
        <download-detail-modal v-if="downloadFlag" :theme-modules="'wecomAgent'"
...
<script>
    ...
    import { getFunnelOption } from '../chartUtils/chartOptions';
        ...
        methods: {
            ...
            loadMoreTask(checkerTask) {
                ...
                // , 0:邮件,1:短信,2:微信,3:彩信 14.应用消息 15.企业群发
                    .getTasks([], '', [this.journeyId], this.taskPageNumber++, this.taskKeyWord, '', 14,
            ...
            //ready 下载
            toDownload() {
                if (this.taskIds.length === 0) return this.$toast(this.$t('data.selectTask'), 'warn');
