window.addEventListener("load", function(){
  const dmt_alink = document.createElement("iframe");
  dmt_alink.id = `dmtiframe`;
  const dmt_origin = "https://oss.dmartech.cn/public/NbOg2FFuhOisSZwT_DMT_1018.html";
  dmt_alink.src = `${dmt_origin}?origin=${window.location.origin}`;
  dmt_alink.style["top"] = "0";
  dmt_alink.style["left"] = "0";
  dmt_alink.style["width"] = "0px";
  dmt_alink.style["opacity"] = "0";
  dmt_alink.style["height"] = "0px";
  dmt_alink.style["z-index"] = "-1";
  dmt_alink.style["display"] = "none";
  dmt_alink.style["position"] = "absolute";
  dmt_alink.style["border"] = "1px solid red";
  dmt_alink.style["transform"] = "translate(-100%, -100%)";
  document.body.appendChild(dmt_alink);
  /**
   * 说明
  ...
  if(!window.dmt_js_sdk){
    ...
    dmt_js_sdk.setUuidToCookie = function (uuid){
      ...
      dmt_alink.contentWindow.postMessage(cookie,dmt_origin);
    }
